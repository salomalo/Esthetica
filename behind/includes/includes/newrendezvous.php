<?php
$javascript = '';
$minDate = date_create("+2 days");
$minDate->setTime(8, 0, 0);
...
<script type="text/javascript">
    $(document).ready(function (e) {
        ...
        $('.date').datetimepicker({
            ...
            useCurrent: false,
            minuteStepping: 30,
            minDate: moment.unix(<?php echo $minDate->getTimestamp() - 60; ?>),
            language: 'fr',
        ...
        $('.date').data('DateTimePicker').setDate(moment.unix(<?php echo $minDate->getTimestamp(); ?>));
    });</script>
<div class="col-md-12">
