			...
			<div class="tab-content col-md-9">
				<div class="tab-pane active" id="home">
					...
					if(Session::exists('flash')) {
						...
						unset($css);
						echo '
					<div class="' . $flash['status'] . ' alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' . $flash['message'] . '</div>';
					}
					?>
					<form class="form-horizontal" role="form" action="index.php?action=update" method="post">
						...
						<div class="form-group">
							<div class="col-md-offset-4 col-md-8">
								<a href="index.php?action=facebookLogin&fromUpdate=1" class="btn btn-primary"><span class="glyphicon glyphicon-cloud-download"></span> Resynchroniser</a>
							</div>
						</div>
						<?php
						}
