...
?>
		<div class="jumbotron">
            <h1>Parrainage</h1>
            <p class="lead">Lorsque vous référez nos services à vos amis, nous nous assurons de vous offrir un cadeau à utiliser chez Ongles Trycia. Vous aurez droit à une carte cadeau de 25$<sup>*</sup> en référant un nouveau client.</p>
