...
$javascript = '';
$token_valid = Token::check(Input::get('token'));
if (Input::exists()) {
    if ($token_valid) {
...
<script type="text/javascript">
    $(document).ready(function (e) {
        $(document).attr('title', 'Inscription - Esthética');
    });
</script>
<div class="row">
    <div class="col-lg-offset-1 col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="index.php?action=register2&inputFirstName=<?php echo escape(Session::get('inputFirstName')); ?>&inputLastName=<?php echo escape(Session::get('inputLastName')); ?>&inputEmail=<?php echo escape(Session::get('inputEmail')); ?>&inputGender=<?php echo escape(Session::get('inputGender')); ?>&token=<?php echo $token; ?>">Étape 2</a></li>
        ...
        <form class="form-horizontal" role="form" action="index.php?action=register3" method="post">
            ...
            <div id="lastNameGroup" class="form-group">
                ...
                <div class="col-lg-4">
                    <p class="form-control-static"><?php echo escape(Session::get('inputLastName')); ?> <a class="btn btn-primary btn-xs" href="index.php?action=register2&inputFirstName=<?php echo escape(Session::get('inputFirstName')); ?>&inputLastName=<?php echo escape(Session::get('inputLastName')); ?>&inputEmail=<?php echo escape(Session::get('inputEmail')); ?>&inputGender=<?php echo escape(Session::get('inputGender')); ?>&token=<?php echo $token; ?>">modifier</a></p>
                </div>
            </div>
            <div id="emailGroup" class="form-group">
                <label for="inputEmail" class="col-lg-3 col-lg-offset-1 control-label">Courriel</label>
                <div class="col-lg-4">
                    <p class="form-control-static"><?php echo escape(Session::get('inputEmail')); ?> <a class="btn btn-primary btn-xs" href="index.php?action=register2&inputFirstName=<?php echo escape(Session::get('inputFirstName')); ?>&inputLastName=<?php echo escape(Session::get('inputLastName')); ?>&inputEmail=<?php echo escape(Session::get('inputEmail')); ?>&inputGender=<?php echo escape(Session::get('inputGender')); ?>&token=<?php echo $token; ?>">modifier</a></p>
                </div>
            </div>
