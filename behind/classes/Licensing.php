...
class Licensing {
    ...
    function validateLicense() {
        ...
        $whmcsurl = $this->whmcsurl;
        $licensing_secret_key = $this->secret_key; # Unique value, should match what is set in the product configuration for MD5 Hash Verification
        ...
        if (!$localkeyvalid) {
            ...
            $query_string = "licensekey=" . $postfields["licensekey"] . "&domain=" . $postfields["domain"] . "&ip=" . $postfields["ip"] . "&dir=" . $postfields["dir"] . "&";
